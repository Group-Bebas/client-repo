        ...
        data.forEach(place => {
            ...
            if (place.rating >= 4.6) {
                $('#cardsPlaces').append(`
                    <div class="ui card">
                    <div class="content">
                    <a class="ui red small right ribbon label">Top</a>
...
function modalPlace (name, address, rating, photo) {
    ...
    $('#photoPlace').attr('src',`https://maps.googleapis.com/maps/api/place/photo?maxwidth=400&photoreference=${photo}&key=AIzaSyC3EXj-tIVry5UeM3LZAem86iMwrSpJPmY`)
